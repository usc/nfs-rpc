...
public class Netty4BenchmarkServer extends AbstractBenchmarkServer {
    ...
    public void run(String[] args) throws Exception {
        ...
        System.out.println(dateFormat.format(new Date()) + " ready to start server,listenPort is: " + listenPort + ",threads num is:" + concurrency + ",responseSize is:" + responseSize + " bytes");
