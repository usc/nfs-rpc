...
public class GrizzlyClientInvocationHandler extends AbstractClientInvocationHandler {
    ...
    public GrizzlyClientInvocationHandler(List<InetSocketAddress> servers, int clientNums, int connectTimeout, String targetInstanceName, Map<String, Integer> methodTimeouts, int codecType, int protocolType) {
